...
class FyLoadingRotatingDots extends StatefulWidget {
  final double size;
  final Color color;
  ...
  @override
  State<FyLoadingRotatingDots> createState() => _FyLoadingRotatingDotsState();
}

class _FyLoadingRotatingDotsState extends State<FyLoadingRotatingDots>
